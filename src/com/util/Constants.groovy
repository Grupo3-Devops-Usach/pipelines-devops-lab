...
class Constants {
    ...
    public static final IC_STAGES = [STAGE_COMPILE, STAGE_UNITTEST, STAGE_JAR, STAGE_SONAR, STAGE_NEXUSUPLOAD, STAGE_GITCREATERELEASE] as String[]
    public static final RELEASE_STAGES = [STAGE_GITDIFF, STAGE_NEXUSDOWNLOAD, STAGE_RUN, STAGE_TEST, STAGE_GITMERGEMASTER, STAGE_GITMERGEDEVELOP, STAGE_GITTAGMASTER] as String[]
}